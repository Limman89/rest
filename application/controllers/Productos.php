...
class Productos extends REST_Controller {
  ...
  public function cambiar_precio_post( $codigo, $precio ){
    $query = $this->db->query( 'UPDATE `productos` SET precio_compra = '. $precio .' where codigo = "'. $codigo .'"' );
    $respuesta = array(
            'error' => FALSE,
            'mensaje' => 'Precio cambiado' 
    );
